...
var mod = angular.module('tlFilters', []);
...
var mod = angular.module('tlScrolling', []);
/// <reference path="scrollmanager.directive.ts" />
/// <reference path="scrollable.directive.ts" />
/// <reference path="scrollsender.directive.ts" />
/// <reference path="horizontalscrollreceiver.directive.ts" />
/// <reference path="verticalscrollreceiver.directive.ts" />
mod.directive('scrollManager', function () {
...
mod.directive('verticalScrollReceiver', function () {
    // The element with this attribute will scroll at the same time as the scrollSender element
    return {
        restrict: 'A',
        require: '^scrollManager',
...
mod.directive('horizontalScrollReceiver', function () {
    // The element with this attribute will scroll at the same time as the scrollSender element
    return {
        restrict: 'A',
        require: '^scrollManager',
...
//}]); 
var mod = angular.module('tlWindow', []);
mod.directive('tlHeightOf', [
    "$rootScope",
    function ($rootScope) {
        return {
            restrict: 'A',
...
/// <reference path="triarc/web/tlfilters.ts" />
/// <reference path="triarc/web/tlscrolling.ts" />
/// <reference path="triarc/web/tlwindow.ts" />
